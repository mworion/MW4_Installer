====================================
 Contributing to InstallerMW4
====================================

There are many ways you can contribute to InstallerMW4.

* **Contributing documentation** in the form of python doc, and documents like this.
* **Using InstallerMW4;** reporting bugs and patches into the issue tracker.
 ...
 * https://github.com
2. We fork mworion/InstallerMW4's repo.
 * https://github.com/mworion/InstallerMW4
3. We git clone our Fork to a local working copy on our own machine. 
 * git clone https://github.com/<YOUR ID HERE>/InstallerMW4
...
8. On Github we submit a pull request from this forked branch into 
   mworion/InstallerMW4's main repo.
 ...
 * git clone git@github.com:mworion/InstallerMW4.git
3. Add skyfield reference to my local git repo.
 * git remote add skyfield git@github.com:mworion/InstallerMW4.git
 * git fetch InstallerMW4
 ...
 * git checkout master
 * git rebase InstallerMW4/master
...
From this point you can actually keep fetching from InstallerMW4 repo as follows:
...
* git fetch InstallerMW4
* git checkout -b issue43 InstallerMW4/master
